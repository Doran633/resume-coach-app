...
def analyze_long_input(raw_input: str, write_segmentation_log: bool = False, stage: str = "unknown") -> LongInputContext:
    ...
    partition = segment_semantic_experiences(raw_input, write_log=write_segmentation_log, stage=stage)
    segments = enrich_segments(split_experience_segments(raw_input, segmentation_result=partition))
